...
<html lang = "en">
	...
	<div class = "navbar navbar-default navbar-fixed-top">
		<img src = "images/logo.png" style = "float:left;" height = "55px"><label class = "navbar-brand">San Roque Medical Clinic - San Roque Medical Clinic</label>
	...
	<div id = "footer">
		<label class = "footer-title">&copy; Copyright IETI-ALABANG ALL RIGHTS RESERVED 2018</label>
	</div>
	</body>
