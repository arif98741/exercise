...
<html lang = "en">
	...
	<div class = "navbar navbar-default navbar-fixed-top">
		<img src = "images/logo.png" style = "float:left;" height = "55px" /><label class = "navbar-brand">SAN ROQUE MEDICAL CLINIC - Muntinlupa City</label>
	...
	<div class = "well">
		...
		<a href = "no-url-yet.php" id = "d_record" style = "float:right; margin-right:10px;" class = "btn btn-success"><span class = "glyphicon glyphicon-book"></span> View Appointments</a>
	...
	<div id = "footer">
		<label class = "footer-title">&copy; International Electronics & Technical Institute 2017</label>
	</div>
	</body>
