	...
	<div id="print">
		<div style = "margin:10px;">	
			...
			<div style = "float:left; margin-left:50px;">	
				<label><center>San Roque Medical Clinic DIAGNOSTIC LABORATORY</center></label>
				<label style = "font-size:14px;"><center>San Roque Medical Clinic - Muntinlupa City</center></label>
