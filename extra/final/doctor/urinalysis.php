...
<html lang = "en">
	...
	<div class = "well">
		...
		<a href = "view_urinalysis_record.php" id = "d_record" style = "float:right; margin-right:10px;" class = "btn btn-success"><span class = "glyphicon glyphicon-book"></span> View Appointments</a>
